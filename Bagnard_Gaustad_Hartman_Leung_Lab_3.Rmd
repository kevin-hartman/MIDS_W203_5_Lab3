...
-- DELETE ME --
The **Density** of an area can have significant impacts on:
...
Right away, we can see clear difference between each regions' logpolpc regression on logcrmerte."Other" and "Central" regions have positively slopped regression lines, while "West" has a negatively slopped regression line. This suggests that we should investigate the interactions between logpolpc and region (regcode) in our model. 
