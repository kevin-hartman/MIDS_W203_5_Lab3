...
1 Trimming - *remove* outliers from the dataset based on a local maxima or minima from the mean.
...
We will reassign the value in our dataset to the mean of these trials.
