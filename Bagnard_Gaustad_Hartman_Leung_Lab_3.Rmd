...
* **MLR3** Through the VIF function, we know that all of our variance inflation factors are less than 5, which allows us to conclude that our variables in model2 aer not perfectly multicolinear.
...
* **MLR5: Homoscedasticity** The above Residuals vs Fitted graph provides evidence of heteroscedasticity as right side of the chart have fewer datepoints. To provide further evidence of heteroscedasticity, we will use the Huber-White test with vcovHC. 

using White and Huber's method and generate coefficients that are robust to heteroscedasticity.
