...
- logcrimJustEff: If we were to increase criminal justice efficiency by 1%, we would expect the crime rate to decrease by approximately 0.42%.
- logpolpc: If we were to increase police per capita by 1%, we would expect the crime rate to increase by approximately 0.56%.
...
* Density: If we increase density by 100 people per square mile, we expect the crime rate to increase by approximately 6.9%.  
...
* Density: Density is statistically significant at the 95% confidence level and represents a large practical effect as an increase in 100 people per square mile leads to approximately 6.9% increase in the crime rate.  
